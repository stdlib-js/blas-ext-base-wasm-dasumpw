...
*
* // Perform operation:
* var sum = dasumpw.ndarray( 4, x, 2, 1 );
* // returns 9.0
*/
function Routine() {
...
* // returns 5.0
*/
setReadOnly( Routine.prototype, 'main', function dasumpw( N, x, strideX ) {
...
* // returns 9.0
*/
setReadOnly( Routine.prototype, 'ndarray', function dasumpw( N, x, strideX, offsetX ) {
	var ptrs;
	var p0;
