...
var O=require('@stdlib/assert-is-wasm-memory/dist'),y=require('@stdlib/utils-define-nonenumerable-read-only-property/dist'),S=require('@stdlib/utils-inherit/dist'),q=require('@stdlib/wasm-module-wrapper/dist'),g=require('@stdlib/error-tools-fmtprodmsg/dist'),j=c();function a(e){if(!(this instanceof a))return new a(e);if(!O(e))throw new TypeError(g('29lH0',e));return q.call(this,j,e,{env:{memory:e}}),this}S(a,q);y(a.prototype,"main",function(r,i,t){return this._instance.exports.stdlib_strided_dasumpw(r,i,t)});y(a.prototype,"ndarray",function(r,i,t,o){return this._instance.exports.stdlib_strided_dasumpw_ndarray(r,i,t,o)});m.exports=a
