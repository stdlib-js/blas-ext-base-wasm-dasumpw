...
// Attached to the main export is a `main` method which returns a number...
{
	...
	dasumpw.main( x.length, x, 1 ); // $ExpectType number
}
...
// The compiler throws an error if the `main` method is provided a first argument which is not a number...
{
	...
	dasumpw.main( '10', x, 1 ); // $ExpectError
	dasumpw.main( true, x, 1 ); // $ExpectError
	dasumpw.main( false, x, 1 ); // $ExpectError
	dasumpw.main( null, x, 1 ); // $ExpectError
	dasumpw.main( undefined, x, 1 ); // $ExpectError
	dasumpw.main( [], x, 1 ); // $ExpectError
	dasumpw.main( {}, x, 1 ); // $ExpectError
...
// The compiler throws an error if the `main` method is provided a second argument which is not a Float64Array...
{
	...
	dasumpw.main( x.length, 10, 1 ); // $ExpectError
	dasumpw.main( x.length, '10', 1 ); // $ExpectError
	dasumpw.main( x.length, true, 1 ); // $ExpectError
	dasumpw.main( x.length, false, 1 ); // $ExpectError
	dasumpw.main( x.length, null, 1 ); // $ExpectError
	dasumpw.main( x.length, undefined, 1 ); // $ExpectError
	dasumpw.main( x.length, [], 1 ); // $ExpectError
	dasumpw.main( x.length, {}, 1 ); // $ExpectError
...
// The compiler throws an error if the `main` method is provided a third argument which is not a number...
{
	...
	dasumpw.main( x.length, x, '10' ); // $ExpectError
	dasumpw.main( x.length, x, true ); // $ExpectError
	dasumpw.main( x.length, x, false ); // $ExpectError
	dasumpw.main( x.length, x, null ); // $ExpectError
	dasumpw.main( x.length, x, undefined ); // $ExpectError
	dasumpw.main( x.length, x, [] ); // $ExpectError
	dasumpw.main( x.length, x, {} ); // $ExpectError
	dasumpw.main( x.length, x, ( x: number ): number => x ); // $ExpectError
}
...
// Attached to the main export is a `Module` constructor which returns a module...
{
	...
	dasumpw.Module( mem ); // $ExpectType Module
}

// The compiler throws an error if the `Module` constructor is not provided a WebAssembly memory instance...
{
	dasumpw.Module( '10' ); // $ExpectError
	dasumpw.Module( true ); // $ExpectError
	dasumpw.Module( false ); // $ExpectError
	dasumpw.Module( null ); // $ExpectError
	dasumpw.Module( undefined ); // $ExpectError
	dasumpw.Module( [] ); // $ExpectError
	dasumpw.Module( {} ); // $ExpectError
	dasumpw.Module( ( x: number ): number => x ); // $ExpectError
}
